package fan.akua.wrapper.insets
...
import fan.akua.wrapper.layoutinflater.LayoutInflaterFactory
    ...
    companion object {
        ...
        fun attach(view: View, attrs: AttributeSet) {
            ...
            val layout_fitsSystemWindowsInsets =
                a.getIntOrReference(
                    R.styleable.WindowInsetsHelper_layout_fitsSystemWindowsInsets,
                    0
                )
        ...
        fun attach(
            ...
            view.setTag(R.id.tag_akua_material_WindowInsetsHelper, listener)
...
val View.windowInsetsHelper: WindowInsetsHelper?
    get() {
        val value = getTag(R.id.tag_akua_material_WindowInsetsHelper)
